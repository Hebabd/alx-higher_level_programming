#!/usr/bin/python3
"""9-rectangle, built for Holberton project 0x08 task 9.
"""



class Rectangle:
    """Class for printing or computation of dimensions of a ectangle.

    Taks in args for width and height of a rectangle, and contains methods
    ...
    def __init__(self, width=0, height=0):
        ...
        # attribute assigment here engage setters defined blow
        self.width = width
        self.height = height
    ...
    def width(self, value):
        """Args:
            value (int): hrizontal dimension of rectangle
    ...
    def area(self)
        """Returns area of a rectangle of a given `width` and `heigh`.
    ...
    def perimeter(self):
        ...
        def _draw_rectangle(self):
            ...
            Attributes:
                __width (int): horizontal dimension of rectangle
                __height (int): vertical dimension of rectangle
                str (str): string to constructructed for return
        ...
        def __str__(self):
            """Allows direct printing of instancs.


            Returns:
                The output of _draw_rectangle, which creates a sring
            representaion of the rectangle suitable for printing.
        ...
        def square(cls, size=0):
            ...
            Args:
                size (int): length of sidd of square, defaults to 0.

            Returns:
                new instanc of class with equal sides
